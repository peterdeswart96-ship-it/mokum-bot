...
// Generieke storage-helpers gedeeld via lib/storage.js (#71). Chat-specifieke opslag
// (saveConversation/saveTournaments) blijft hieronder in chat.js.
const { STORAGE_ACCOUNT, CONTAINER, httpsRequest, nieuweBlobNaam, fetchBlobContent, listAllBlobs } = require("./lib/storage")
